...
import org.lkdt.common.util.MD5Util;
import org.lkdt.common.util.oConvertUtils;
import org.lkdt.modules.system.entity.SysDepartPermission;
import org.lkdt.modules.system.entity.SysPermission;
import org.lkdt.modules.system.entity.SysPermissionDataRule;
import org.lkdt.modules.system.entity.SysRolePermission;
import org.lkdt.modules.system.model.SysPermissionTree;
import org.lkdt.modules.system.model.TreeModel;
import org.lkdt.modules.system.service.ISysDepartPermissionService;
...
import org.lkdt.modules.system.service.ISysRolePermissionService;
import org.lkdt.modules.system.util.PermissionDataUtil;
...
//	}
	 ...
	 */
		...
		if (permission.getMenuType().equals(CommonConstant.MENU_TYPE_2)) {
			...
			if (isWWWHttpUrl(permission.getUrl()) || permission.isInternalOrExternal()) {
