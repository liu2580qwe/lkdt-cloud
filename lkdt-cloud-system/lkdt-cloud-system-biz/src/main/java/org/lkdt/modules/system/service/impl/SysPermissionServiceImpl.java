...
import org.lkdt.modules.system.entity.SysPermission;
import org.lkdt.modules.system.entity.SysPermissionDataRule;
import org.lkdt.modules.system.mapper.SysDepartPermissionMapper;
import org.lkdt.modules.system.mapper.SysDepartRolePermissionMapper;
import org.lkdt.modules.system.mapper.SysPermissionMapper;
import org.lkdt.modules.system.mapper.SysRolePermissionMapper;
import org.lkdt.modules.system.model.TreeModel;
import org.lkdt.modules.system.service.ISysPermissionDataRuleService;
import org.lkdt.modules.system.service.ISysPermissionService;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermission(String id) throws CloudException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new CloudException("未找到菜单信息");
		}
	...
	public void deletePermissionLogical(String id) throws CloudException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new CloudException("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void addPermission(SysPermission sysPermission) throws CloudException {
		//----------------------------------------------------------------------
		//判断是否是一级菜单，是的话清空父菜单
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws CloudException {
