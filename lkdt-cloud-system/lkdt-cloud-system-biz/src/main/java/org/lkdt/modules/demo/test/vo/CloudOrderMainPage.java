package org.lkdt.modules.demo.test.vo;
...
@Data
public class CloudOrderMainPage {
	...
	private List<CloudOrderCustomer> jeecgOrderCustomerList;
	@ExcelCollection(name="机票")
	private List<CloudOrderTicket> jeecgOrderTicketList;
