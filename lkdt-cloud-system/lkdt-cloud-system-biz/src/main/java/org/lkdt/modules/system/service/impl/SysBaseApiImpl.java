...
import org.lkdt.common.constant.DataBaseConstant;
...
import org.lkdt.modules.message.service.ISysMessageTemplateService;
import org.lkdt.modules.message.websocket.WebSocket;
import org.lkdt.modules.system.entity.*;
import org.lkdt.modules.system.mapper.*;
import org.lkdt.modules.system.service.ISysDataSourceService;
import org.lkdt.modules.system.service.ISysDepartService;
import org.lkdt.modules.system.service.ISysDictService;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public String parseTemplateByCode(String templateCode,Map<String, String> map) {
        ...
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new CloudException("消息模板不存在，模板编码："+templateCode);
        }
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new CloudException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
