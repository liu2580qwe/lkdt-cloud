...
import org.lkdt.modules.config.GatewayRouteInitEvent;
import org.lkdt.modules.system.entity.SysGatewayRoute;
import org.lkdt.modules.system.mapper.SysGatewayRouteMapper;
...
public class SysGatewayRouteServiceImpl extends ServiceImpl<SysGatewayRouteMapper, SysGatewayRoute> implements ApplicationEventPublisherAware, ISysGatewayRouteService {
    ...
    public void updateAll(JSONObject json) {
        ...
        try {
            this.remove(new LambdaQueryWrapper<SysGatewayRoute>().eq(SysGatewayRoute::getId, json.getString("id")));
