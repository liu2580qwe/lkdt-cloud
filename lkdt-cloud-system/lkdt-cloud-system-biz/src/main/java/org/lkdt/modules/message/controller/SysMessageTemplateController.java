package org.lkdt.modules.message.controller;
...
import org.lkdt.modules.message.entity.MsgParams;
...
import org.lkdt.modules.message.util.PushMsgUtil;
...
public class SysMessageTemplateController extends CloudController<SysMessageTemplate, ISysMessageTemplateService> {
	@Autowired
