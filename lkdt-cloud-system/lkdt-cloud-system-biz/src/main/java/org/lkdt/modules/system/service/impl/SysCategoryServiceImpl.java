...
import org.lkdt.common.constant.FillRuleConstant;
import org.lkdt.common.exception.CloudException;
import org.lkdt.common.util.FillRuleUtil;
import org.lkdt.common.util.oConvertUtils;
import org.lkdt.modules.system.entity.SysCategory;
import org.lkdt.modules.system.mapper.SysCategoryMapper;
import org.lkdt.modules.system.model.TreeSelectModel;
import org.lkdt.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	public List<TreeSelectModel> queryListByCode(String pcode) throws CloudException {
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list==null || list.size() ==0) {
				throw new CloudException("该编码【"+pcode+"】不存在，请核实!");
			}
			if(list.size()>1) {
				throw new CloudException("该编码【"+pcode+"】存在多个，请核实!");
			}
