...
import org.lkdt.modules.api.factory.SysUserRemoteApiFallbackFactory;
...
public interface SysUserRemoteApi {
     ...
     * @return
     */
    @GetMapping("/sys/sysDepart/queryDepartListByUid")
    Result<List<SysDepartModel>> queryDepartListByUid(@RequestParam(name = "userId", required = true) String userId);
