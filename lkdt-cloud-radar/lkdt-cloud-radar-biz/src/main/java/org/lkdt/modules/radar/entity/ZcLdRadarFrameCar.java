...
/**
 * (ZcLdRadarFrameCar)实体类
 *
 * @author makejava
 * @since 2021-04-16 12:01:34
 */
@Data
@TableName("zc_ld_radar_frame_car")
@ApiModel(value="zc_ld_radar_frame_car对象", description="雷达数据帧检测目标表")
public class ZcLdRadarFrameCar implements Serializable, Comparable<ZcLdRadarFrameCar>{
    ...
    * 外键关联帧主键
    */
    @ApiModelProperty(value = "外键关联帧主键")
    ...
    */
     ...
     */
    @Override
    public int compareTo(ZcLdRadarFrameCar o) {
        if(this.sY < o.sY){
            return -1;
