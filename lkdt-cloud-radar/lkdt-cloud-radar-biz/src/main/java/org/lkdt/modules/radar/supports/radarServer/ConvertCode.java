...
public class ConvertCode {
	 ...
	 * @param strHex_X
	 * @param strHex_Y
	 *            注意：此方法是针对一个十六进制字符串一字节之间的异或运算，如对十五字节的十六进制字符串异或运算：1312f70f
	 *            900168d900007df57b4884 先进行拆分：13 12 f7 0f 90 01 68 d9 00 00 7d
	 *            f5 7b 48 84 13 xor 12-->1 1 xor f7-->f6 f6 xor 0f-->f9 .... 62
	 *            xor 84-->e6 即，得到的一字节校验码为：e6
	 * @return
	 */
	...
	// 16));
	// String thisBinary = Integer.toBinaryString(Integer.valueOf(strHex_Y,
	// 16));
	// String result = "";
	// // 判断是否为8位二进制，否则左补零
	...
	public static String receiveHexToString(byte[] by) {
		try {
			 ...
			 * ByteBufInputStream is = new ByteBufInputStream(buf); byte[] by =
			 * input2byte(is);
			 */
	...
	public static void main(String args[]) {
		String hexstring = "110310BA00146270";
