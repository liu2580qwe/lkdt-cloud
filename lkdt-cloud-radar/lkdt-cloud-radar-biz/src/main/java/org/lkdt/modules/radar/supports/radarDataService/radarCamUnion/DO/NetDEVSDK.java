...
public interface NetDEVSDK extends StdCallLibrary {

	public static String libraryPath = "C:\\\\NETDEVSDK_Win64_V2.5.0.9\\\\bin\\\\NetDEVSDK";
//	public static String libraryPath = "NetDEVSDK";

 	NetDEVSDK INSTANCE = (NetDEVSDK) Native.loadLibrary(libraryPath, NetDEVSDK.class);
	...
	public static NETDEV_PREVIEWINFO_S getNewNETDEV_PREVIEWINFO_S_instance(int dwChannelNum){
		NetDEVSDK.NETDEV_PREVIEWINFO_S pstPreviewInfo = new NetDEVSDK.NETDEV_PREVIEWINFO_S();
		pstPreviewInfo.dwChannelID = dwChannelNum;
		//pstPreviewInfo.dwStreamType = 1;
		pstPreviewInfo.dwStreamType = 1;//0、1、2：清晰度依次递减
