 ...
 * 新算法计算雷达车流量
 */
public class CalcRadarDataCarFlowShell2min2 {
...
//                                                }
                    ...
                    if(dateTime.getMinutes() == 29 && count29 == 0){
                        count29 = 1;
                        dataSetCarFlowHour.addValue(count1, "1车道", (i)*30 + "min");
                        dataSetCarFlowHour.addValue(count2, "2车道", (i)*30 + "min");
                        dataSetCarFlowHour.addValue(count3, "3车道", (i)*30 + "min");
                        dataSetCarFlowHour.addValue(count4, "4车道", (i)*30 + "min");
                        dataSetCarFlowHour.addValue(count5, "5车道", (i)*30 + "min");
                        dataSetCarFlowHour.addValue(count6, "6车道", (i)*30 + "min");
                        dataSetCarFlowHour.addValue(count7, "7车道", (i)*30 + "min");
                    }

                    if(dateTime.getMinutes() == 59 && count59 == 0){
                        count59 = 1;
                        dataSetCarFlowHour.addValue(count1, "1车道", (i+1)*30 + "min");
                        dataSetCarFlowHour.addValue(count2, "2车道", (i+1)*30 + "min");
                        dataSetCarFlowHour.addValue(count3, "3车道", (i+1)*30 + "min");
                        dataSetCarFlowHour.addValue(count4, "4车道", (i+1)*30 + "min");
                        dataSetCarFlowHour.addValue(count5, "5车道", (i+1)*30 + "min");
                        dataSetCarFlowHour.addValue(count6, "6车道", (i+1)*30 + "min");
                        dataSetCarFlowHour.addValue(count7, "7车道", (i+1)*30 + "min");
                    }
            ...
            generateLineJPEG(dataSetCarFlowHour, "1001车流量-以30min为区间", "车流量/30min","30min" ,
                    "C:\\Users\\zhangzhenbiao\\Desktop\\未去噪-车流量每30min.jpg");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
