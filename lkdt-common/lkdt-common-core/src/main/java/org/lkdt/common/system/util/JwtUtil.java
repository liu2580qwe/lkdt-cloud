package org.lkdt.common.system.util;
...
public class JwtUtil {
	...
	// APP Token过期时间7天（用户登录过期时间是此时间的两倍，以token在reids缓存时间为准）
	 ...
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws CloudException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new CloudException("未获取到用户");
		}
		return username;
	}
	 ...
	 * @throws CloudException
	 */
	public static LoginUser getLoginUser() throws CloudException {
