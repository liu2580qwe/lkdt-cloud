package org.lkdt.common.es;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang.StringUtils;
import org.lkdt.common.util.RestUtil;
...
public class ElasticsearchTemplate {
    ...
    public ElasticsearchTemplate(@Value("${lkdt.elasticsearch.cluster-nodes}") String baseUrl, @Value("${lkdt.elasticsearch.check-enabled}") boolean checkEnabled) {
