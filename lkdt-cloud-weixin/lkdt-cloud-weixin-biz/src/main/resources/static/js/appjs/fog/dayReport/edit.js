...
function update() {
	$.ajax({
		cache : true,
		type : "POST",
		url : "/fog/dayReport/update",
		data : {reportId: $("#reportId").val(), reportDate: $("#reportDate").val(), reportUser: $("#reportUser").val(),
			reportContent: he.getHtml(), remark: $("#remark").val()},// 你的formid
		async : false,
