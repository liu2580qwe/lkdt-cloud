    ...
    $('#exampleTable').bootstrapTable(
        {
            ...
            url : prefix + "/findBindList", // 服务器数据的加载地址
            //	showRefresh : true,
            //	showToggle : true,
            //	showColumns : true,
            iconSize : 'outline',
...
function bind($this){
    ...
    let index = parseInt($this.parentNode.parentNode.parentNode.childNodes[0].getAttribute("data-index"));
    let row = data[index];
