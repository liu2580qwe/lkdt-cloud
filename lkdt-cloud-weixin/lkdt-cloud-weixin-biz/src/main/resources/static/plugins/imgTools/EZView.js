...
$.fn.EZView = function(){
        ...
        if (!$('#EZView').length) {
            ...
            var tools = 
                ...
                container = '<div class="object"/>'+
                        ...
                        tools,
                template = '<div id="EZView" class="hide container" style="display: flex !important; align-items: center; justify-content: center">'+container+'</div>';
    ...
    self.setStyles = function(){
        // Set Styles
        $EZView.css({
            'background-color': 'rgba(6,90,150,0.5)',
            'height':           '100%',
            'width':            '100%',
            'z-index':          '10000',
            'position':         'fixed',
        ...
        .find('.tools-container').css({
            'background-color': 'rgba(17,166,224,0.5)',
            'height':           '35px',
            'width':            '100%',
            'position':         'fixed',
            'top':              '0',
