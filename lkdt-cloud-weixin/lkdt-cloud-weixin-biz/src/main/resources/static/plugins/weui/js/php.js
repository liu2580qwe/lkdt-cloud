...
function date(n, t) {
	...
	r = {
		...
		S: function() {
			var n = r.j(),
				t = n % 10;
			return t <= 3 && 1 === parseInt(n % 100 / 10, 10) && (t = 0),
			["st", "nd", "rd"][t - 1] || "th"
		},
		w: function() {
			return e.getDay()
	...
	return function(n, t) {
		return e = void 0 === t ? new Date: t instanceof Date ? new Date(t) : new Date(1e3 * t),
			n.replace(o, i)
	} (n, t)
}
...
function mktime() {
	...
	for (r = 0; r < n.length; r++) if (void 0 === t[r]) t[r] = e["get" + n[r]](),
		t[r] += 3 === r;
	else if (t[r] = parseInt(t[r], 10), isNaN(t[r])) return ! 1;
...
function array_slice(r, i, e, t) {
	...
	if ("[object Array]" !== Object.prototype.toString.call(r) || t && 0 !== i) {
		...
		for (o in r) {
			if (++f, s >= e) break;
			f === i && (l = !0),
			l && (++s, is_int(o) && !t ? n[v++] = r[o] : n[o] = r[o])
		}
		return n
	}
...
function array_merge() {
	var r, e = Array.prototype.slice.call(arguments),
		t = e.length,
		o = {},
		a = "",
		n = 0,
	...
	for (l = 0, f = 0; l < t; l++) if (r = e[l], "[object Array]" === i.call(r)) for (c = 0, n = r.length; c < n; c++) o[f++] = r[c];
	else for (a in r) r.hasOwnProperty(a) && (parseInt(a, 10) + "" === a ? o[f++] = r[a] : o[a] = r[a]);
	return o
}
function count(r, t) {
	var n, o = 0;
...
function range(r, a, N) {
	var i, o, s = [],
		e = N || 1,
		f = !1;
	if (isNaN(r) || isNaN(a) ? isNaN(r) && isNaN(a) ? (f = !0, i = r.charCodeAt(0), o = a.charCodeAt(0)) : (i = isNaN(r) ? 0 : r, o = isNaN(a) ? 0 : a) : (i = r, o = a), !(i > o)) for (; i <= o;) s.push(f ? String.fromCharCode(i) : i),
		i += e;
	else for (; i >= o;) s.push(f ? String.fromCharCode(i) : i),
		i -= e;
	return s
}
function unset() {
...
function is_array(t) {
	...
	if (function(t) {
		...
		var e = t.length;
		return t[t.length] = "bogus",
			e !== t.length ? (t.length -= 1, !0) : (delete t[t.length], !1)
	} (t)) return ! 0;
...
function function_exists(n) {
	...
	return "string" == typeof n && (n = o[n]),
	"function" == typeof n
}
function uniqid(n, e) {
	void 0 === n && (n = "");
	var t, i = function(n, e) {
			return n = parseInt(n, 10).toString(16),
				e < n.length ? n.slice(n.length - e) : e > n.length ? Array(e - n.length + 1).join("0") + n: n
		},
		o = "undefined" != typeof window ? window: global;
	o.$locutus = o.$locutus || {};
	var d = o.$locutus;
	return d.php = d.php || {},
	d.php.uniqidSeed || (d.php.uniqidSeed = Math.floor(123456789 * Math.random())),
		d.php.uniqidSeed++,
		t = n,
		t += i(parseInt((new Date).getTime() / 1e3, 10), 8),
		t += i(d.php.uniqidSeed, 5),
...
function rtrim(e, r) {
	return r = r ? (r + "").replace(/([[\]().?\/*{}+$^:])/g, "\\$1") : " \\s ",
		(e + "").replace(new RegExp("[" + r + "]+$", "g"), "")
}
function ltrim(e, r) {
	return r = r ? (r + "").replace(/([[\]().?\/*{}+$^:])/g, "$1") : " \\s ",
		(e + "").replace(new RegExp("^[" + r + "]+", "g"), "")
...
function str_replace(t, o, e, c) {
	...
	var v = j.$locutus;
	if (v.php = v.php || {},
	"object" == typeof t && "string" == typeof o) {
		for (n = o, o = [], r = 0; r < t.length; r += 1) o[r] = n;
		n = "",
			f = [].concat(o),
			y = "[object Array]" === Object.prototype.toString.call(f)
	}
	for (void 0 !== c && (c.value = 0), r = 0, i = g.length; r < i; r++) if ("" !== g[r]) for (l = 0, p = u.length; l < p; l++) n = g[r] + "",
		a = y ? void 0 !== f[l] ? f[l] : "": f[0],
		g[r] = n.split(u[l]).join(a),
	void 0 !== c && (c.value += n.split(u[l]).length - 1);
	return b ? g: g[0]
}
...
function compact() {
	...
	return function n(r) {
		var e = 0,
			...
			i = "";
		for (e = 0; e < c; e++) i = r[e],
			"[object Array]" === Object.prototype.toString.call(i) ? n(i) : void 0 !== t[i] && (o[i] = t[i]);
		return ! 0
	} (arguments),
		o
}
...
function htmlspecialchars_decode(e, E) {
	...
	return E & t.ENT_HTML_QUOTE_SINGLE && (e = e.replace(/&#0*39;/g, "'")),
	r || (e = e.replace(/&quot;/g, '"')),
		e = e.replace(/&amp;/g, "&")
}
function htmlspecialchars(e, E, T, _) {
	var r = 0,
		t = 0,
		a = !1; ("undefined" == typeof E || null === E) && (E = 2),
		e = e.toString(),
	_ !== !1 && (e = e.replace(/&/g, "&amp;")),
	...
	return E & N.ENT_HTML_QUOTE_SINGLE && (e = e.replace(/'/g, "&#039;")),
	a || (e = e.replace(/"/g, "&quot;")),
		e
};
...
function base64_decode(n) {
	...
	var e, t, o, i, d, f, a, c, u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
		h = 0,
		w = 0,
		C = "",
		g = [];
...
function base64_encode(e) {
	var r = function(e) {
		return encodeURIComponent(e).replace(/%([0-9A-F]{2})/g,
			function(e, r) {
	...
	var n, t, o, i, a, c, d, f, h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
		u = 0,
		w = 0,
		A = "",
		l = [];
...
function urlencode(e) {
	return e += "",
		encodeURIComponent(e).replace(/!/g, "%21").replace(/'/g, "%27").replace(/\(/g, "%28").replace(/\)/g, "%29").replace(/\*/g, "%2A").replace(/~/g, "%7E").replace(/%20/g, "+")
}
function urldecode(e) {
	return decodeURIComponent((e + "").replace(/%(?![\da-f]{2})/gi,
		function() {
			return "%25"
		}).replace(/\+/g, "%20"))
}
	...
	return u = (o ?
		function(e, n) {
			...
			var t = ("" + e).split("e"),
				i = "";
			return + t[1] + n > 0 && (i = "+"),
				( + (Math.round( + t[0] + "e" + i + ( + t[1] + n)) + "e-" + n)).toFixed(n)
		} (r, o).toString() : "" + Math.round(r)).split("."),
	u[0].length > 3 && (u[0] = u[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, a)),
	(u[1] || "").length < o && (u[1] = u[1] || "", u[1] += new Array(o - u[1].length + 1).join("0")),
		u.join(d)
}
...
function fn() {
	...
	for (o in this.window) try {
		if ("function" == typeof this.window[o]) n[o] || (n[o] = 1, t.push(o));
		else if ("object" === _typeof(this.window[o])) for (var i in this.window[o])"function" == typeof this.window[i] && this.window[i] && !n[i] && (n[i] = 1, t.push(i))
	} catch(o) {}
	return t
}
var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ?
	...
	function(e) {
		var t = {};
		e.localStorage ? t.support = !0 : t.support = !1,
			t.set = function(e, o, i) {
				if (this.support) {
			...
			t.setCookie = function(e, t, o) {
				if ("string" == typeof e) {
					...
					i.setTime(i.getTime() + o),
						document.cookie = e + "=" + t + "; expires=" + i.toGMTString()
				}
			},
...
function hidebank(s = "6217995510035399947") {
	return s.replace(/^(\d{8})\d+(\d{4})$/, "$1*******$2");
}
function hidephone(s = "18291447788") {
...
function isfollowqr() {
	var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "https://open.weixin.qq.com/qr/code?username=gh_61981472de64",
	...
	var t = 1 == o ? '<span class="close" onclick="isfollowqrRemove()"></span>': "",
		l = 1 == o ? "onclick=\"isfollowqrRemove()\"": "";
